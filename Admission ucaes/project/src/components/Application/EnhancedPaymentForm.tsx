...
import { CreditCard, PhoneAndroid, AttachMoney, CheckCircle, Warning, Loop, Security, Schedule } from '@mui/icons-material';
  ...
  const renderPaymentView = () => {
    switch (paymentStep) {
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <PaymentMethodCard
                    method="mobile_money"
                    icon={<PhoneAndroid className="h-6 w-6 text-green-600" />}
                    title="Mobile Money"
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start">
                  <Security className="h-5 w-5 text-blue-600 mt-0.5 mr-2" />
                  <div>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start">
                  <Warning className="h-5 w-5 text-yellow-600 mt-0.5 mr-2" />
                  <div>
      ...
      case 'processing':
        return (
          <div className="text-center py-12">
            <Loop className="h-16 w-16 text-green-600 mx-auto animate-spin mb-4" />
      ...
      case 'error':
        return (
          <div className="text-center py-8">
            <Warning className="h-20 w-20 text-red-600 mx-auto mb-4" />
