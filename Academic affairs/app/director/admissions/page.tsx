...
function AdmissionsDashboard() {
  ...
  const filteredApplications = (Array.isArray(applications) ? applications : []).filter((app) => {
    const formattedRegNumber = formatRegistrationNumber(app.applicationId)
    const matchesSearch =
      app.firstName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      app.lastName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      app.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
      app.applicationId.toLowerCase().includes(searchTerm.toLowerCase()) ||
      formattedRegNumber.toLowerCase().includes(searchTerm.toLowerCase())
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {selectedApplication.firstName} {selectedApplication.lastName} - {formatRegistrationNumber(selectedApplication.applicationId)}
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-lg font-bold font-mono">{formatRegistrationNumber(selectedApplication.applicationId)}</div>
            ...
            <TableBody>
              {filteredApplications.map((app) => (
                <TableRow key={app.id} className={app.programType === 'topup' ? 'bg-blue-50' : ''}>
                  <TableCell className="font-mono text-sm">{formatRegistrationNumber(app.applicationId)}</TableCell>
